...
class FitsInfo(FitsImage, FileNames):
    ...
    def get_fwhm(self, force = False, nominal = 5):
        ...
        if 'FWHM' in self.hdulist[0].header:
            self.fwhm = self.hdulist[0].header['FWHM']
    ...
    def get_zeromag(self):
        ...
        if 'ZEROMAG' in self.hdulist[0].header:
            self.zero = self.hdulist[0].header['ZEROMAG']
    ...
    def get_sky(self):
        ...
        if 'SKY' in self.hdulist[0].header:
            self.sky = self.hdulist[0].header['SKY']
