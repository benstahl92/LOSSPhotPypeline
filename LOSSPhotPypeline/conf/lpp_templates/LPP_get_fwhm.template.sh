...
sextractor $filename -c ${sexconfpath}/fwhm.sex -PARAMETERS_NAME ${sexconfpath}/fwhm.par -FILTER_NAME ${sexconfpath}/gauss_2.0_5x5.conv -STARNNW_NAME ${sexconfpath}/default.nnw -VERBOSE_TYPE QUIET
