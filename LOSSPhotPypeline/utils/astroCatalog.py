...
class astroCatalog:
    ...
    def get_cal_arrays(self, use = True, index_order = None):
        ...
        for cterm in ['kait1', 'kait2', 'kait3', 'kait4', 'nickel1', 'nickel1', 'Landolt']:
            ...
            if use is False:
                use = ''
            with fits.open(os.path.join(self.relative_path, 'cal_{}_{}{}_{}.fit'.format(self.targetname, self.cal_source, tmp, ct))) as f:
                cal = f[1].data
                tmp = {}
                ...
                if index_order is not None:
                    tmp.index = index_order
                cal_arrays[cterm] = tmp
